  ...
  <div class="encuesta">
    ...
    <v-form v-model="form_valid" v-if="!completado" class="preguntas">
      ...
      <v-card variant="tonal" color="blue" class="categoria-header">
        ...
        <v-card-subtitle
          >Datos sobre tu situación escolar actual</v-card-subtitle
        >
      </v-card>
      ...
      <v-card
        title="Carrera"
        subtitle="Selecciona la carrera que estás estudiando."
        variant="plain"
      >
        <template v-slot:prepend>
      ...
      <!-- PROMEDIO -->
      <v-card
        title="Promedio del semestre anterior (0-100)"
        subtitle="Ingresa el promedio del semestre anterior."
        variant="plain"
      >
        <template v-slot:prepend>
      ...
      <v-card
        ...
        subtitle="Ingresa el semestre que estás cursando actualmente."
        variant="plain"
      >
        <template v-slot:prepend>
      ...
      <v-card
        ...
        subtitle="Ingresa la cantidad de materias que cursas en este semestre."
        variant="plain"
      >
        <template v-slot:prepend>
      ...
      <v-card variant="plain">
            ...
            <v-tooltip location="bottom" max-width="320">
              ...
              <div>
                ...
                <div class="text-body-2">
                  Como tipo de profesor estricto se identifican aquellos que
        ...
        <v-card-subtitle
          >Indica cuántos de tus profesores actuales consideras
          estrictos</v-card-subtitle
        >
        <v-card-text>
          <v-select
      ...
      <v-card variant="tonal" color="green" class="categoria-header mt-2">
        ...
        <v-card-subtitle
          >Datos sobre tu situación laboral y económica</v-card-subtitle
        >
      </v-card>
      ...
      <v-card
        title="Trabajo"
        subtitle="Selecciona si trabajas mientras estudias."
        variant="plain"
      >
        <template v-slot:prepend>
      ...
      <v-card
        title="Beca"
        subtitle="Selecciona si tienes alguna beca."
        variant="plain"
      >
        <template v-slot:prepend>
      ...
      <v-card
        title="Transporte"
        subtitle="Selecciona la forma en que te transportas al instituto."
        variant="plain"
      >
        <template v-slot:prepend>
      ...
      <v-card variant="tonal" color="orange" class="categoria-header mt-2">
        ...
        <v-card-subtitle
          >Datos sobre tu situación personal y de vida</v-card-subtitle
        >
      </v-card>
      ...
      <v-card
        title="Hogar"
        subtitle="Selecciona con quiénes vives."
        variant="plain"
      >
        <template v-slot:prepend>
      ...
      <v-card
        title="Hijos"
        subtitle="¿Tienes hijos actualmente?"
        variant="plain"
      >
        <template v-slot:prepend>
    ...
    <div v-else>
      <v-card
        title="¡Gracias!"
        subtitle="Se han registrado las respuestas."
        variant="tonal"
        color="blue"
      >
        <v-card-text
